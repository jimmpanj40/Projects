...
int PulseTime = 0; //the time between 2 SetPulse
int StepFig=0; //indicate the current step of the figure selected
int Figure = 6; //indicate the figure selected
int PreviousFigure=6 ; //indicate the previous figure executed
int EnableChangeFig=1; //1 = Change Figure is enable ; 0 = We can't change the current figure
